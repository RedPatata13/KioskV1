...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RenameStaffIdToUserId
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RenameStaffIdToUserId))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202503290222049_RenameStaffIdToUserId"
            End Get
        End Property
