...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddEditorIdRequired
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddEditorIdRequired))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504212313320_AddEditorIdRequired"
            End Get
        End Property
