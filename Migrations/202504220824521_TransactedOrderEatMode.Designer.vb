...
Namespace Migrations
    ...
    Public NotInheritable Partial Class TransactedOrderEatMode
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TransactedOrderEatMode))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504220824521_TransactedOrderEatMode"
            End Get
        End Property
