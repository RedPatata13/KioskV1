...
Namespace Migrations
    ...
    Public NotInheritable Partial Class BatchRename
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(BatchRename))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504242201160_BatchRename"
            End Get
        End Property
