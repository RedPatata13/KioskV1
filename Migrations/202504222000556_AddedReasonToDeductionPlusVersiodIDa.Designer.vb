...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedReasonToDeductionPlusVersiodIDa
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedReasonToDeductionPlusVersiodIDa))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504222000556_AddedReasonToDeductionPlusVersiodIDa"
            End Get
        End Property
