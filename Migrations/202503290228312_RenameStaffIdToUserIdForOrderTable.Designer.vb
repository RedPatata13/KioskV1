...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RenameStaffIdToUserIdForOrderTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RenameStaffIdToUserIdForOrderTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202503290228312_RenameStaffIdToUserIdForOrderTable"
            End Get
        End Property
