...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddedReasonToDeductionPlusVersiodID
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddedReasonToDeductionPlusVersiodID))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504221953159_AddedReasonToDeductionPlusVersiodID"
            End Get
        End Property
