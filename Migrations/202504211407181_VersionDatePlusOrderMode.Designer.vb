...
Namespace Migrations
    ...
    Public NotInheritable Partial Class VersionDatePlusOrderMode
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(VersionDatePlusOrderMode))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504211407181_VersionDatePlusOrderMode"
            End Get
        End Property
