...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddTotalCostToSupplierTransaction
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddTotalCostToSupplierTransaction))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202504090713235_AddTotalCostToSupplierTransaction"
            End Get
        End Property
