Public Class StaffPaymentUserControl
    ...
    Private Sub ReceivedAmountTextBox_TextChanged(sender As Object, e As KeyPressEventArgs) Handles ReceivedAmountTextBox.KeyPress, ReceivedAmountTextBox.TextChanged
