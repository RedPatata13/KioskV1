...
Namespace KioskV0.Forms
    Public Class AdminDashboardView
        ...
        Private Property _order As List(Of OrderPrimal)
        Public Property Order As List(Of OrderPrimal)
            Get
                Return _order
            End Get
            Set(value As List(Of OrderPrimal))
                _order = value
            End Set
        End Property
        ...
        Public Sub LoadChart()
            ...
            For Each sale In _order
                salesValues.Add(sale.TotalPrice) ' Add sales amount
